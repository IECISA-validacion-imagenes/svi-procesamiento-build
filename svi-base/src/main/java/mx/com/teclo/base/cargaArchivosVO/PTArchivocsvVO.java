...
public class PTArchivocsvVO {
			
		private long idPtLote;
		private EntregaVO idEntrega;
		...
		private Long totalRegistroxLote;
		 ...
		 */
		public EntregaVO getIdEntrega() {
			return idEntrega;
		}
		/**
		 * @param idEntrega the idEntrega to set
		 */
		public void setIdEntrega(EntregaVO idEntrega) {
		...
		public Long getTotalRegistroxLote() {
			return totalRegistroxLote;
		}
		public void setTotalRegistroxLote(Long totalRegistroxLote) {
			this.totalRegistroxLote = totalRegistroxLote;
		}
